...
export const AuthShell = ({ eyebrow = 'Welcome', title, description, children, footer }) => (
  <main className="min-h-[calc(100vh-8.25rem)] px-3 py-5 sm:px-6 lg:grid lg:min-h-[calc(100vh-5rem)] lg:grid-cols-[0.95fr_1.05fr] lg:gap-6 lg:p-6">
    <section className="surface-grid relative hidden overflow-hidden rounded-[2rem] bg-[#19221d] p-10 text-white lg:flex lg:flex-col lg:justify-between">
    ...
    <section className="flex items-center justify-center py-6 sm:py-10">
      <div className="w-full max-w-lg animate-fade-up">
        ...
        <div className="rounded-[1.75rem] border border-black/[0.06] bg-white p-5 shadow-[var(--shadow-card)] sm:p-8">{children}</div>
